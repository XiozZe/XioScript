XSCL.push({
	row: "Price",
	name: "CTIE Price",
	description: "For all selected production subdivisions and warehouses: set the price of the products to their prime cost increased by their CTIE. The price cannot exceed 30x IP.",	
	code: function(){
